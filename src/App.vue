...
a {
  cursor: pointer; /* Ini sebenarnya tidak perlu karena default <a> sudah pointer */
}

/* Mengubah warna saat di-hover */
a:hover h3 {
  color: #6b93d6; /* Warna lebih muda dari #4d6ee6 */
}

/* Opsi lain, jika Anda ingin mengubah warna ikon Instagram saat di-hover */
a:hover img {
  filter: brightness(1.2); /* Membuat gambar sedikit lebih terang */
}
</style>
